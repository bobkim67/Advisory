...
|---|---:|---:|---:|
| product_weight_sum | 1.000000 | 0.752153 | **1.000000** |
| n_products | 17 | 17 | **23** |
...
| us_value_equity | 2 | 2 | **2** | 32.72% | 32.72% |
...
|---|---|---|---|---:|
| 42669 | 한화천연자원자(주식)P클래스 | 한화운용 | core | 5.62% |
| 71463 | 피델리티재팬자(주식-재간접)CP | 피델리티운용 | satellite | 0.70% |
| 70744 | 삼성일본리더스전환자 1[주식](Cp(퇴직연금)) | 삼성운용 | satellite | 0.70% |

### us_high_yield

| product_id | product_name | manager | role | weight |
|---|---|---|---|---:|
| 71800 | 베어링글로벌하이일드자[UH](채권-재간접)ClassC-P2e | 베어링운용 | core | 0.71% |
| 71791 | 베어링글로벌하이일드자[H](채권-재간접)ClassC-P2 | 베어링운용 | satellite | 0.09% |
| 74369 | 교보악사미국코어하이일드자(UH)[채권-재간접]_ClassC-Re(퇴직연금) | 교보악사운용 | satellite | 0.09% |
...
|---:|---|---|---|---:|---:|---:|
| 1 | 2074 | NH-Amundi성장중소형주[주식]ClassC-P2(퇴직연금) | NH-Amundi운용 | 0.80% | 27.37% | 26.57% |
| 2 | 76305 | KB미국대표성장주자(주식)(UH)C-퇴직 | KB운용 | 30.00% | 4.51% | -25.49% |
| 3 | 74176 | 삼성미국그로스자UH[주식-재간접]_Cp(퇴직연금) | 삼성운용 | 20.30% | 0.56% | -19.74% |
| 4 | 73125 | AB미국그로스UH(주식-재간접)종류C-P2 | AB자산운용 | 20.30% | 0.56% | -19.74% |
| 5 | 42351 | HDC알짜배당(주식)종류C-Pe | HDC운용 | 0.00% | 13.50% | 13.50% |
| 6 | 42669 | 한화천연자원자(주식)P클래스 | 한화운용 | 0.00% | 5.62% | 5.62% |
| 7 | 70467 | 한국투자미국배당귀족자UH(주식)(C-R) | 한국투자신탁운용 | 21.92% | 26.17% | 4.26% |
| 8 | 71976 | 마이다스아시아리더스성장주자(UH)(주식)C-P2 | 마이다스운용 | 0.10% | 3.42% | 3.32% |
| 9 | 71972 | 마이다스아시아리더스성장주자(H)(주식)C-P2 | 마이다스운용 | 0.10% | 3.42% | 3.32% |
| 10 | 11688 | 코레이트셀렉트단기채[채권]C-P2 | 코레이트운용 | 0.00% | 1.69% | 1.69% |

## §9. Limitation 해소 여부 vs R-1F.2

| issue | R-1F.2 | R-1G.2 |
|---|---|---|
| product_weight_sum ≈ 1.0 | 0.7522 (invalid) | **1.000000** (valid) |
