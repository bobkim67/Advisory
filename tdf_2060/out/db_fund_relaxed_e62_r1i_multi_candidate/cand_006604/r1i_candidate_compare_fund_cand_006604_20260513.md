...
|---|---:|---:|---:|
| product_weight_sum | 1.000000 | 0.685037 | **1.000000** |
| n_products | 17 | 17 | **26** |
...
| us_value_equity | 2 | 2 | **2** | 16.59% | 16.59% |
...
| us_high_yield | 3 | 3 | **3** | 11.03% | 11.03% |
...
|---|---|---|---|---:|
| 42669 | 한화천연자원자(주식)P클래스 | 한화운용 | core | 12.40% |
| 71463 | 피델리티재팬자(주식-재간접)CP | 피델리티운용 | satellite | 1.55% |
| 70744 | 삼성일본리더스전환자 1[주식](Cp(퇴직연금)) | 삼성운용 | satellite | 1.55% |

### us_high_yield

| product_id | product_name | manager | role | weight |
|---|---|---|---|---:|
| 71800 | 베어링글로벌하이일드자[UH](채권-재간접)ClassC-P2e | 베어링운용 | core | 8.82% |
| 71791 | 베어링글로벌하이일드자[H](채권-재간접)ClassC-P2 | 베어링운용 | satellite | 1.10% |
| 74369 | 교보악사미국코어하이일드자(UH)[채권-재간접]_ClassC-Re(퇴직연금) | 교보악사운용 | satellite | 1.10% |
...
|---:|---|---|---|---:|---:|---:|
| 1 | 74176 | 삼성미국그로스자UH[주식-재간접]_Cp(퇴직연금) | 삼성운용 | 20.30% | 1.69% | -18.61% |
| 2 | 73125 | AB미국그로스UH(주식-재간접)종류C-P2 | AB자산운용 | 20.30% | 1.69% | -18.61% |
| 3 | 76305 | KB미국대표성장주자(주식)(UH)C-퇴직 | KB운용 | 30.00% | 13.55% | -16.45% |
| 4 | 43306 | 한국밸류10년투자파이오니아(주식)(C-Re) | 한국투자밸류운용 | 0.80% | 14.13% | 13.33% |
| 5 | 2074 | NH-Amundi성장중소형주[주식]ClassC-P2(퇴직연금) | NH-Amundi운용 | 0.80% | 13.86% | 13.06% |
| 6 | 42669 | 한화천연자원자(주식)P클래스 | 한화운용 | 0.00% | 12.40% | 12.40% |
| 7 | 71800 | 베어링글로벌하이일드자[UH](채권-재간접)ClassC-P2e | 베어링운용 | 0.00% | 8.82% | 8.82% |
| 8 | 70467 | 한국투자미국배당귀족자UH(주식)(C-R) | 한국투자신탁운용 | 21.92% | 13.27% | -8.65% |
| 9 | 70455 | 한국투자미국배당귀족자H(주식)(C-R) | 한국투자신탁운용 | 5.48% | 3.32% | -2.16% |
| 10 | 42351 | HDC알짜배당(주식)종류C-Pe | HDC운용 | 0.00% | 2.02% | 2.02% |

## §9. Limitation 해소 여부 vs R-1F.2

| issue | R-1F.2 | R-1G.2 |
|---|---|---|
| product_weight_sum ≈ 1.0 | 0.6850 (invalid) | **1.000000** (valid) |
