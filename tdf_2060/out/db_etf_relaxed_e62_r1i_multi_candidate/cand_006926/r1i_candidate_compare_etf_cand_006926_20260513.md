...
- candidate_id: **cand_006926**. target_weight_source: `r1f2_projection_final_asset_weights`.

## §3. 3-way Headline

| metric | A. baseline (max-Sharpe) | B. R-1F.2 (proportional) | C. R-1G.2 (full reselection + builder) |
|---|---:|---:|---:|
| product_weight_sum | 1.000000 | 1.832809 | **1.000000** |
| n_products | 17 | 17 | **23** |
...
|---|---:|---:|---:|---:|
| kr_equity | 1.00% | 2.65% | 2.65% | 1.65% |
| us_growth_equity | 70.60% | 5.64% | 5.64% | -64.97% |
| us_value_equity | 27.40% | 32.72% | 32.72% | 5.32% |
| dm_ex_us_equity | 0.00% | 7.02% | 7.02% | 7.02% |
| em_equity | 1.00% | 34.21% | 34.21% | 33.21% |
| kr_aggregate_bond | 0.00% | 16.87% | 16.87% | 16.87% |
| kr_treasury_10y | 0.00% | 0.00% | 0.00% | 0.00% |
| us_treasury_30y | 0.00% | 0.00% | 0.00% | 0.00% |
| us_high_yield | 0.00% | 0.89% | 0.89% | 0.89% |

## §5. Per-asset Product Counts & R-1G.2 Allocation

| asset | A picks | B picks | C picks | C alloc | C target |
|---|---:|---:|---:|---:|---:|
| kr_equity | 3 | 3 | **3** | 2.65% | 2.65% |
| us_growth_equity | 3 | 3 | **3** | 5.64% | 5.64% |
| us_value_equity | 3 | 3 | **3** | 32.72% | 32.72% |
| dm_ex_us_equity | 3 | 3 | **3** | 7.02% | 7.02% |
| em_equity | 3 | 3 | **3** | 34.21% | 34.21% |
| kr_aggregate_bond | 0 | 0 | **3** | 16.87% | 16.87% |
| kr_treasury_10y | 0 | 0 | **0** | 0.00% | 0.00% |
| us_treasury_30y | 0 | 0 | **3** | 0.00% | 0.00% |
| us_high_yield | 2 | 2 | **2** | 0.89% | 0.89% |
...
|---|---|---|---|---:|
| 238720 | 한국투자ACE일본Nikkei225상장지수(주식-파생)(H) | 한국투자신탁운용 | core | 5.62% |
| 101280 | 삼성KODEX일본TOPIX100상장지수[주식] | 삼성운용 | satellite | 0.70% |
| 251350 | 삼성KODEXMSCI선진국상장지수[주식] | 삼성운용 | satellite | 0.70% |

### us_high_yield

| product_id | product_name | manager | role | weight |
|---|---|---|---|---:|
| 468380 | 삼성KODEXiShares미국하이일드액티브상장지수[채권-재간접] | 삼성운용 | core | 0.71% |
| 455660 | 한국투자ACE미국하이일드액티브상장지수[채권-재간접](H) | 한국투자신탁운용 | satellite | 0.18% |

## §7. Top Changed Assets (|R-1G.2 − baseline|)

| # | asset | Δ |
|---:|---|---:|
| 1 | us_growth_equity | -64.97% |
| 2 | em_equity | 33.21% |
| 3 | kr_aggregate_bond | 16.87% |
| 4 | dm_ex_us_equity | 7.02% |
| 5 | us_value_equity | 5.32% |

## §8. Top Changed Products (|R-1G.2 − baseline|, top 10)

| # | product_id | name | manager | A base | C R-1G.2 | Δ |
|---:|---|---|---|---:|---:|---:|
| 1 | 411420 | 삼성KODEX미국나스닥AI테크액티브상장지수[주식] | 삼성운용 | 20.00% | 0.56% | -19.44% |
| 2 | 381180 | 미래에셋TIGER미국필라델피아반도체나스닥상장지수(주식) | 미래에셋운용 | 20.00% | 0.56% | -19.44% |
| 3 | 446690 | 삼성KODEX아시아AI반도체exChina액티브상장지수[주식] | 삼성운용 | 1.76% | 20.00% | 18.24% |
| 4 | 426030 | 타임폴리오TIME미국나스닥100액티브상장지수(주식) | 타임폴리오자산운용 | 20.00% | 4.51% | -15.49% |
| 5 | 497880 | 신한SOLCD금리&머니마켓액티브상장지수[채권] | 신한자산운용 | 0.00% | 13.50% | 13.50% |
| 6 | 277540 | 한국투자ACE아시아TOP50상장지수(주식) | 한국투자신탁운용 | 1.06% | 7.11% | 6.04% |
| 7 | 105010 | 미래에셋TIGER라틴상장지수(주식) | 미래에셋운용 | 1.06% | 7.11% | 6.04% |
| 8 | 238720 | 한국투자ACE일본Nikkei225상장지수(주식-파생)(H) | 한국투자신탁운용 | 0.96% | 5.62% | 4.65% |
| 9 | 446720 | 신한SOL미국배당다우존스상장지수[주식] | 신한자산운용 | 4.66% | 6.36% | 1.70% |
| 10 | 429000 | 미래에셋TIGER미국S&P500배당귀족상장지수(주식) | 미래에셋운용 | 4.66% | 6.36% | 1.70% |

## §9. Limitation 해소 여부 vs R-1F.2

| issue | R-1F.2 | R-1G.2 |
|---|---|---|
| product_weight_sum ≈ 1.0 | 1.8328 (invalid) | **1.000000** (valid) |
