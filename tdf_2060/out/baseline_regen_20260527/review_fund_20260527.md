...
| gold | -1.0000% | redistribution_from_long_only_clipping | +0.0000% | none |
| us_growth_equity | -1.0000% | redistribution_from_long_only_clipping | +0.0000% | none |
| us_high_yield | -1.0000% | redistribution_from_long_only_clipping | +0.0000% | none |
| em_equity | -1.0000% | redistribution_from_long_only_clipping | +0.0000% | none |
| kr_equity | -1.0000% | redistribution_from_long_only_clipping | +0.0000% | none |
...
|---|---|---|---|---|---:|---:|---|
| kr_equity | equity | 한국밸류10년투자파이오니아(주식)(C-Re) | 한국투자밸류운용 | core | — | +0.8000% | - |
| kr_equity | equity | NH-Amundi필승코리아[주식]ClassC-P2(퇴직연금) | NH-Amundi운용 | satellite | — | +0.1000% | - |
| kr_equity | equity | 교보악사파워인덱스자 1[주식]ClassCP | 교보악사운용 | satellite | — | +0.1000% | - |
| us_growth_equity | equity | KB미국대표성장주자(주식)(UH)C-퇴직 | KB운용 | core | — | +30.0000% | unfilled_cause=product_cap_clipping |
| us_growth_equity | equity | 삼성미국그로스자UH[주식-재간접]_Cp(퇴직연금) | 삼성운용 | satellite | — | +9.1811% | unfilled_cause=product_cap_clipping, fallback_absorber |
| us_growth_equity | equity | AB미국그로스UH(주식-재간접)종류C-P2 | AB자산운용 | satellite | — | +9.1811% | unfilled_cause=product_cap_clipping, fallback_absorber |
| em_equity | equity | NH-Amundi성장중소형주[주식]ClassC-P2(퇴직연금) | NH-Amundi운용 | core | — | +0.8000% | - |
| em_equity | equity | 마이다스아시아리더스성장주자(H)(주식)C-P2 | 마이다스운용 | satellite | — | +0.1000% | - |
| em_equity | equity | 마이다스아시아리더스성장주자(UH)(주식)C-P2 | 마이다스운용 | satellite | — | +0.1000% | - |
...
| gold | equity | iM에셋월드골드자(주식-재간접)(UH)(C-Rp) | iM에셋운용 | core | — | +30.0000% | unfilled_cause=product_cap_clipping |
| gold | equity | 신한골드 1[주식](종류C-r) | 신한자산운용 | satellite | — | +9.8189% | unfilled_cause=product_cap_clipping, fallback_absorber |
| gold | equity | iM에셋월드골드자(주식-재간접)(H)(C-Rp) | iM에셋운용 | satellite | — | +9.8189% | unfilled_cause=product_cap_clipping, fallback_absorber |
| us_high_yield | fixed_income | 베어링글로벌하이일드자[UH](채권-재간접)ClassC-P2e | 베어링운용 | core | — | +0.0000% | - |
| us_high_yield | fixed_income | 베어링글로벌하이일드자[H](채권-재간접)ClassC-P2 | 베어링운용 | satellite | — | +0.0000% | - |
| us_high_yield | fixed_income | 교보악사미국코어하이일드자(UH)[채권-재간접]_ClassC-Re(퇴직연금) | 교보악사운용 | satellite | — | +0.0000% | - |
...
| VAL-04 | warning | validation | fallback_used: us_growth_equity 8.6897% redistributed → ['us_growth_equity'] (cause=product_cap_clipping) | D-12 | — |
| VAL-05 | warning | validation | fallback_used: gold 9.7103% redistributed → ['gold'] (cause=product_cap_clipping) | D-12 | — |
| VAL-06 | warning | validation | max_abs_asset_weight_drift: 0.0000% | - | — |
