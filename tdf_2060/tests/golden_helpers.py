...
GOLDEN_RT_NAME_TO_KEY = {
    ...
    "신흥국주식": "em_equity",
    "금": "gold",                          # 2026-05-27 신규 (사용자 결정 equity 편입)
    "한국채권": "kr_aggregate_bond",        # 둘 중 첫 번째 한국채권 컬럼
    "미국채권": "us_aggregate_bond",        # 2026-05-27 신규 (LBUSTRUU)
    "미국하이일드": "us_high_yield",
    # 답안지에 있지만 우리 10 자산군에 없는 것: 글로벌주식/미국주식/미국나스닥/호주/
    #                                           미국물가채/미국투자등급/미국외채권/신흥국달러표시/
    #                                           원자재/미국리츠/미국외리츠/글로벌인프라/한국채권.1
}
